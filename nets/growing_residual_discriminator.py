...
from .growing_discriminator import GrowingDiscriminator
import tensorflow as tf
from .blocks import *


class GrowingResidualDiscriminator(GrowingDiscriminator):
    ...
    def block(self, x, output_dim, s=1, name="block"):
        return residual_block(x, dim=output_dim, act=self.act, norm=self.norm, sn=self.sn, ks=3, s=s, type=residual, name=name)
